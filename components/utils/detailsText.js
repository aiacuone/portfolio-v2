export const detailsTextObj = {
  tekkenNet: {
    ...
    why: () => {
      return (
        <p>
          ...
          website created by a Tekken enthusiast at & nbsp;
          <a
          ...
          .Within this website, you'll find that the moves are displayed in a
          raw data table.
          <br />
          <br />
          My project Tekken Net looks to simplify the problem by letting the
          user input various details based on a move they wish to view the
          details of, and Tekken Net displays the information.
        </p>
      )
    },
    ...
    learn: () => {
      return (
        <p>
          Everything. This being my first project which has gone through 3
          different iterations, I learnt all the basics about React. To list a
          few would be hooks, state, useEffect, array methods( more specifically
          the the map method), and object methods. <br />
          <br />
          <br />
          <b>What challenges did I face creating this project?</b>
          <br />
          Filtering and displaying information. I had the skills to filter
          information, as well as display information, but to do both at the
          same time was challenging. I overcame the problem by storing my
          filtering functions within an object, then using object indexing, I
          was able to call the correct filtering function when necessary.
        </p>
      )
    },
  },
