  ...
  return (
    <div className="container">
      ...
      <p className={styles.text}>
        ...
        <br />
        <br />
        When I first saw a JavaScript object, what came to mind was a folder, a
        folder that contains another folder and so on. Using this concept and my
        need for notes in my every day life, I wanted to develop an easy to use
        system that could create and store any type of note.
        <br />
        <br />
        ...
        <br />
        <br />
        I learnt alot about giving the user the ability to scroll within tight
        areas, pop up menus and arranging elements in a way that is easily
        viewed and accessed.
        <br />
        <br />
