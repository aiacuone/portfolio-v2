	...
	return (
		<div className="container">
			...
			<p className={styles.text}>
				...
				wanted to express an idea that I had since the first time I saw an
				Javascript object.
				<br />
				<br />
				...
				an easy to use system that is focused towards mobile users.
				<br />
				<br />
				...
				<br />
				<br />
				This projects challenged me to position elements correctly and
				comfortably for the user. I learnt alot about giving the user the
				ability to scroll, make selections, add, delete and edit elements using
				css positioning, displays and attributes likes margins and padding.
				<br />
				<br />
				The Crud system. I stayed true to implenting the CRUD system, as well as
				an in depth system, that is endless in terms of the amount that can be
				stored, as well as there be multiple types of information that can be
				stored.
				<br />
				<br />
				<b>What was the hardest part of this project?</b>
				<br />
				Object Oriented Programming. In React, Applying complicated object
				methods can be challenging and at times impossible. I found that
