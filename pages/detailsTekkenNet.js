  ...
  return (
    <div className="container">
      ...
      <p className={styles.text}>
        ...
        different iterations, I learnt all the basics about React. To list a few
        would be hooks, state, useEffect, array methods( more specifically the
        ...
        time was challenging. I overcame the problem by storing my filtering
        functions within an object, then using object indexing, I was able to
        call the correct filtering function when necessary.
      </p>
    </div>
  )
}
