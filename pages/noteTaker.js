    ...
    <div className="container">
      ...
      <div className={styles.subContainer}>
        ...
        <p>
          ...
          Notes. The notes can be in multiple forms, such as text, images and
          videos. The notes can also be stored within folders that can be named
          and coloured for easy and efficient access.
        </p>
        <h3>Last Updated</h3>
        <p>April, 2021</p>
